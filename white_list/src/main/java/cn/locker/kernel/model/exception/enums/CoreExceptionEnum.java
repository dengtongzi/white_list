package cn.locker.kernel.model.exception.enums;

import cn.locker.kernel.model.exception.AbstractBaseExceptionEnum;

public enum CoreExceptionEnum
  implements AbstractBaseExceptionEnum
{
  ...
  private CoreExceptionEnum(int code, String message) { this.code = Integer.valueOf(code);
