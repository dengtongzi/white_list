...
import cn.locker.core.common.constant.dictmap.base.AbstractDictMap;
...
import cn.locker.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(cn.locker.core.common.annotion.BussinessLog)")
