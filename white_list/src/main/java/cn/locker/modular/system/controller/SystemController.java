...
import cn.locker.core.common.constant.DefaultAvatar;
...
import cn.locker.modular.system.service.FileInfoService;
...
public class SystemController extends BaseController {
    ...
    @ResponseBody
    public Object uploadPicture(@RequestPart("file") MultipartFile picture) {

    	 String pictureName = UUID.randomUUID().toString() + "." + ToolUtil.getFileSuffix(picture.getOriginalFilename());
         try {
             String fileSavePath = lockerProperties.getFileUploadPath();
