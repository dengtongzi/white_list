...
import cn.locker.core.mutidatasource.aop.MultiSourceExAop;
...
@MapperScan(basePackages = {"cn.locker.modular.*.mapper"}, sqlSessionTemplateRef = "lockerSqlSessionTemplate")
public class MultiDataSourceConfig {
     ...
     */
    @Bean
    @ConfigurationProperties(prefix = "locker.muti-datasource")
