...
DROP DATABASE IF EXISTS earthquake_test_db;
CREATE DATABASE IF NOT EXISTS earthquake_test_db DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

USE earthquake_test_db;
