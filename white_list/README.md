<p align="center">
    ...
    <br>      
    <p align="center">
        earthquake基于SpringBoot 2，致力于做更简洁的后台管理系统。earthquake项目代码简洁，注释丰富，上手容易，同时earthquake包含许多基础模块(用户管理，角色管理，部门管理，字典管理等10个模块)，可以直接作为一个后台管理系统的脚手架!
        <br>      
        <br>      
        <span>
            <span>
                earthquake官方交流群：254550081(满)   684163663(满)   207434260
            </span>
        </span>
        <br>
        <br>
...
### earthquake 旗舰版在线demo
账号密码：admin/111111，地址：http://demo.dengtongzi.cn

#### 阿里云5折优惠券
https://www.aliyun.com/acts/product-section-2019/new-users?spm=5176.11533457.1089570.1.226d77e3EWv1Wn&userCode=p4kqz45e

### earthquake VIP计划
earthquake VIP计划，详情点击[https://www.dengtongzi.cn/earthquakeVIP](https://www.dengtongzi.cn/earthquakeVIP)

买vip送最新earthquake技术文档和视频教程，[点击查看技术文档](https://gitee.com/dengtongzi/earthquake/wikis/pages?title=earthquake%E6%8A%80%E6%9C%AF%E6%96%87%E6%A1%A3&parent=)，[点击查看视频教程](https://gitee.com/dengtongzi/earthquake/wikis/pages?title=earthquake%E8%A7%86%E9%A2%91%E6%95%99%E7%A8%8B&parent=)

### Roses企业级微服务视频教程
Roses企业级微服务视频教程，详情点击[https://www.dengtongzi.cn/rosesVideo](https://www.dengtongzi.cn/rosesVideo)

### earthquake历史版本

| 版本名称 | 说明 | 地址 |
| :---: | :---: | :---: |
| earthquake旗舰版 v2.3 | 强力集成atomikos，MM再也不用担心多数据源事务问题，感谢earthquake二群`月下魔术师`兄弟贡献的解决方案 | https://gitee.com/dengtongzi/earthquake/tree/ultimate-v2.3/ |
| earthquake旗舰版 v2.2 | 修复日志模块，记录业务日志，部分字段缺失的问题 | https://gitee.com/dengtongzi/earthquake/tree/ultimate-v2.2/ |
| earthquake旗舰版 v2.1 | 菜单管理表格改为树形表格，部门增加左侧树 | https://gitee.com/dengtongzi/earthquake/tree/ultimate-v2.1/ |
| earthquake旗舰版 v2.0 | 基于layui的全新旗舰版，demo地址：http://demo.dengtongzi.cn | https://gitee.com/dengtongzi/earthquake/tree/ultimate-v2.0/ |
| earthquake旗舰版 v1.1 | 全面升级spring boot和mybatis-plus版本 | https://gitee.com/dengtongzi/earthquake/tree/ultimate-v1.1/ |
| earthquake旗舰版 v1.0 | 全新的UI界面，采用bootstrap 4 + vue，全新的规范化的数据库设计 | https://gitee.com/dengtongzi/earthquake/tree/ultimate-v1.0/ |
| earthquake v5.1 | earthquake经典版的最新版，采用bootstrap 3 | https://gitee.com/dengtongzi/earthquake/tree/v5.1-final |
| earthquake v4.2 | spring boot升级到了2.0，大大简化了前端的体积，升级了一些组件到最新版本 | https://gitee.com/dengtongzi/earthquake/tree/v4.2 |
| earthquake v3.3 | 模块化了整个项目，整体拆分成4个模块，增加了jwt，并集成工作流flowable 6.2.0 | https://gitee.com/dengtongzi/earthquake/tree/v3.3 |
| earthquake v2.4 | 基于spring boot全面升级，更加简化配置和依赖，更专注于开发业务 | https://gitee.com/dengtongzi/earthquake/tree/v2.4/ |
| earthquake v1.0 | earthquake的第一个版本，率先采用spring java bean方式的配置，零spring xml配置，spring用到极致 | https://gitee.com/dengtongzi/earthquake/tree/v1.0/ |

### 版权声明
earthquake经典版(v1.0-v5.1)为`Apache License2`协议，您可以在遵守开源协议的前提下，下载，学习或使用earthquake经典版。

earthquake旗舰版(v1.0-v2.3)采用新的定制协议：您可以随意下载，学习，或使用earthquake，但禁止二次包装出售以及任何商业行为。

### earthquake前端模板
earthquake最新旗舰版，所用前端模板为EasyWeb后台开发框架,官网地址为：[https://easyweb.vip/](https://easyweb.vip/)，使用时已征求作者允许。

### 如有帮助，请多star
earthquake从2017年开源以来，从最初的1.0版本发展到现在的旗舰版2.0，中间历经了十几个版本，一直坚持更新，尽力做到更好！如果earthquake对您有所帮助，请`star`一下项目！支持一下作者！感谢！

### earthquake微服务版本

earthquake的核心是roses-kernel项目[https://gitee.com/dengtongzi-Roses/roses-kernel](https://gitee.com/dengtongzi-Roses/roses-kernel)，提供对spring cloud的支持。

[Roses框架](https://gitee.com/dengtongzi/roses)基于Spring Boot 2和Spring Cloud Finchley.RELEASE，整合Eureka + Hystrix + Ribbon + Feign + Zuul，更符合企业级的分布式和服务化解决方案，Roses拥有高效率的开发体验，提供可靠消息最终一致性分布式事务解决方案，提供基于调用链的服务治理，提供可靠的服务异常定位方案（Log + Trace）等等，一个分布式框架不仅需要构建高效稳定的底层开发框架，更需要解决分布式带来的种种挑战！
...
6. controller层采用map + warpper方式的返回结果，返回给前端更为灵活的数据，具体参见com.dengtongzi.earthquake.modular.system.warpper包中具体类。
...
9. 控制器层统一的异常拦截机制，利用@ControllerAdvice统一对异常拦截，具体见com.dengtongzi.earthquake.core.aop.GlobalExceptionHandler类。
...
### 极简的图片上传方法
earthquake对web-upload进行二次封装，让图片的上传功能呢只用2行代码即可实现，如下
```
...
earthquake的数据范围控制是指，对拥有相同角色的用户，根据部门的不同进行相应的数据筛选，如果部门不相同，那么有可能展示出的具体数据是不一致的.所以说earthquake对数据范围控制是以部门id为单位来标识的，如何增加数据范围拦截呢?只需在相关的mapper接口的参数中增加一个DataScope对象即可，DataScope中有两个字段，scopeName用来标识sql语句中部门id的字段名称，例如deptiid或者id，另一个字段deptIds就是具体需要过滤的部门id的集合.拦截器原理如下:拦截mapper中包含DataScope对象的方法，获取其原始sql，并做一个包装限制部门id在deptIds范围内的数据进行展示.
