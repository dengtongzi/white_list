...
* @describe
* @version 创建时间：2019年7月15日 下午3:13:59
*/
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\\\eclipse-jee-2019-03-R-win32-x86_64\\\\whiteListWork\\\\locker_wx\\\\src\\\\main\\\\java");	//生成文件的输出目录
        gc.setAuthor("dengtongzi");	//作者
...
//        gc.setSwagger2(true);					//开启 swagger2 模式 默认false
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/white_list?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=CTT");
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.locker.weixin");
